// Test: 01:4F:10:0A:00:00:00:63:C8 -  0A000000 is actually 0x0000000A, whose equivalent decimal valueis 1. Divide it by1000, and you will get theactual measurement value 0.01. That means only 1 people here.
// Falta probar camara


function parseUplink(device, payload) {
    var payloadb = payload.asBytes();
    var decoded = Decoder({ bytes: payloadb }, payload.port);
    env.log(decoded);
            ...
            case 'report_telemetry':
                switch (message.measurementId) {
                    case 4099: // Camara
                        ...
                        if (sensor1 != null)
                            sensor1.uploadCameraSnapshot(message.measurementValue);
                        break;

                    case 4175: // Probability
